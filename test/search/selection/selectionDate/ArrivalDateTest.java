...
class ArrivalDateTest {
	...
	void setUp() {
		...
		when(tripOne.calculateArrivalDateToTerminal(quito)).thenReturn(LocalDateTime.of(2023, 11, 26, 20, 0));
		...
		when(tripTwo.calculateArrivalDateToTerminal(quito)).thenReturn(LocalDateTime.of(2023, 12, 3, 12, 0));
	...
	void testTheDateIsLessThanWhatYouAreLookingFor() {
		...
		when(tripOne.calculateArrivalDateToTerminal(quito)).thenReturn(LocalDateTime.of(2023, 11, 20, 20, 0));
		// Assert
		assertEquals(List.of(tripOne), arrivalDate.filterTrips(List.of(tripOne, tripTwo)));
	}
	...
	void testTheDateIsGreatherThanWhatYouAreLookingFor() {
		...
		when(tripOne.calculateArrivalDateToTerminal(quito)).thenReturn(LocalDateTime.of(2023, 11, 30, 20, 0));
		// Assert
		assertEquals(List.of(tripOne), arrivalDate.filterTrips(List.of(tripOne, tripTwo)));
	}
}
